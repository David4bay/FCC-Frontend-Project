    ...
    return (
        <>
            <div className="Quote__Box" id="quote-box">
                        ...
                        <a href={`https://twitter.com/intent/tweet?hashtags=quotes&related=davidbayquotes&text=${data.text}`} className="Tweet__Quote" id="tweet-quote" target='noreferrer _blank'><FaTwitter /></a>
                        <span className="Author" id="author">{data.author === null ? 'Unknown' : data.author}</span>
