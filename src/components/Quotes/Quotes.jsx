    ...
    return (
        <>
            <div className="Quote__Box" id="quote-box">
                        ...
                        <a href={`"https://twitter.com/intent/tweet?hashtags=quotes&related=freecodecamp&text=${data.text}"`} className="Tweet__Quote" id="tweet-quote" target='noreferrer noopener _blank'><FaTwitter /></a>
